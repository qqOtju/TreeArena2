...
namespace Project.Scripts.Config.Enemy
{
    ...
    public struct EnemyValue
    {
        ...
        public EnemyValue(int maxHealth, float moveSpeed, float damage, float attackSpeed, float attackRange, int maxHealthPerWave, float moveSpeedPerWave, float damagePerWave, float attackSpeedPerWave, float attackRangePerWave)
        {
        ...
        {
            var maxHealth = value.MaxHealth * (1 + bonuses.MaxHealth / 100);
