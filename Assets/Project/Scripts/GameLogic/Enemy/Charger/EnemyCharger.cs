...
namespace Project.Scripts.GameLogic.Enemy.Charger
{
    ...
    {
        //ToDo: fix this guy`s physics. He throw another enemies away and 
        ...
        protected override void Start()
        {
            ...
            _stateAttack = new EnemyChargerStateAttack(transform, TargetTree, BasicMovement,
                _stateMachine, Attack, RotateView, Rb);
